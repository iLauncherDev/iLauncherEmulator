...
typedef enum x86_regs
{
    ...
    x86_cache_address0 = x86_cache_reg + 1,
    ...
    x86_cache_rm_precalc = x86_cache_seg_ss + 8,
    x86_cache_mod_precalc = x86_cache_rm_precalc + 256,
    x86_cache_reg_precalc = x86_cache_mod_precalc + 256,
    x86_cache_end = x86_cache_reg_precalc + 256,
