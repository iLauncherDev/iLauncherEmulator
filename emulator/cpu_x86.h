...
typedef enum x86_regs
{
    ...
    x86_reg_bx = x86_reg_ax + 2,
    x86_reg_cx = x86_reg_bx + 2,
    x86_reg_dx = x86_reg_cx + 2,
    x86_reg_bp = x86_reg_dx + 2,
    x86_reg_si = x86_reg_bp + 2,
    x86_reg_di = x86_reg_si + 2,
    x86_reg_sp = x86_reg_di + 2,
    x86_reg_ip = x86_reg_sp + 2,
    ...
    x86_reg_ebx = x86_reg_eax + 4,
    x86_reg_ecx = x86_reg_ebx + 4,
    x86_reg_edx = x86_reg_ecx + 4,
    x86_reg_ebp = x86_reg_edx + 4,
    x86_reg_esi = x86_reg_ebp + 4,
    x86_reg_edi = x86_reg_esi + 4,
    x86_reg_esp = x86_reg_edi + 4,
    x86_reg_eip = x86_reg_esp + 4,
