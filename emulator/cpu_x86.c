...
global_uint64_t x86_rm_read(cpu_t *cpu, uint8_t size)
{
    ...
    case 0x03:
        return cpu_read_reg(cpu, *(global_uint64_t *)&cpu->cache[x86_cache_address0]);
    }
    return 0x00;
}
...
void x86_rm_write(cpu_t *cpu, global_uint64_t value, uint8_t size)
{
    ...
    case 0x00 ... 0x02:
        ...
        break;
    case 0x03:
        cpu_write_reg(cpu, *(uint16_t *)&cpu->cache[x86_cache_address0], value);
        break;
    }
}
...
static inline void x86_decode_rm(cpu_t *cpu, uint16_t reg, uint8_t size)
{
    ...
    case 0x00 ... 0x02:
        ...
        case 0x00:
            *(global_uint64_t *)&cpu->cache[x86_cache_address0] =
                ...
                *(global_int64_t *)&cpu->cache[x86_cache_address0];
            break;
        case 0x01:
            *(global_uint64_t *)&cpu->cache[x86_cache_address0] =
                cpu_read_reg(cpu, x86_reg_bx) +
    ...
    case 0x03 ... 0x04:
        ...
        case 0x04:
            ...
            case 0x08:
                *(global_uint64_t *)&cpu->cache[x86_cache_address0] =
                    cpu_read_reg(cpu, x86_reg_eax) +
                    cpu_read_reg(cpu, x86_reg_ecx) +
                    *(global_int64_t *)&cpu->cache[x86_cache_address0];
                break;
            case 0x24:
                *(global_uint64_t *)&cpu->cache[x86_cache_address0] =
...
void x86_decode(cpu_t *cpu, uint16_t reg, uint8_t size)
{
    ...
    case 0x01:
        *(global_int64_t *)&cpu->cache[x86_cache_address0] = (int8_t)memory_read(cpu->pc, 1, 0);
        cpu->pc += 1;
        return x86_decode_rm(cpu, reg, size);
    case 0x02:
        switch (size)
        {
        case 0x00 ... 0x02:
            *(global_int64_t *)&cpu->cache[x86_cache_address0] = (int16_t)memory_read(cpu->pc, 2, 0);
            cpu->pc += 2;
            break;
        case 0x04:
            *(global_int64_t *)&cpu->cache[x86_cache_address0] = (int32_t)memory_read(cpu->pc, 4, 0);
            cpu->pc += 4;
            break;
        }
        return x86_decode_rm(cpu, reg, size);
...
void x86_jumpif_near(cpu_t *cpu, uint16_t reg, uint16_t flags, global_uint64_t value, uint8_t size)
{
    ...
    if (cpu_read_reg(cpu, flags_reg) & flags)
...
uint8_t x86_emulate(cpu_t *cpu)
{
    ...
    case 0xeb:
        ...
        break;
    case 0xec:
        cpu_write_reg(cpu, x86_reg_al, io_read(cpu_read_reg(cpu, x86_reg_dx), 1));
        break;
    case 0xed:
        if (x86_check_override(cpu, x86_override_dword_operand))
        ...
        break;
    case 0xee:
        io_write(cpu_read_reg(cpu, x86_reg_dx), cpu_read_reg(cpu, x86_reg_al), 1);
        break;
    case 0xef:
        if (x86_check_override(cpu, x86_override_dword_operand))
            io_write(cpu_read_reg(cpu, x86_reg_dx), cpu_read_reg(cpu, x86_reg_eax), 4);
        else
            io_write(cpu_read_reg(cpu, x86_reg_dx), cpu_read_reg(cpu, x86_reg_ax), 2);
        x86_clear_override(cpu, x86_override_dword_operand);
        break;
    case 0xc3:
        if (x86_check_override(cpu, x86_override_dword_operand))
